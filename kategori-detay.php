...
if ($_GET['kategori_id']) {
    ...
    $kategoriVeri = $conn->query('SELECT * FROM not_kategorileri WHERE 
        not_kat_id  = ' . $_GET['kategori_id'] )->fetch(PDO::FETCH_ASSOC);
...
<section class="service-two">
    ...
    <div class="container">
        <div class="block-title text-center">
            ...
            <p>Çeşitler</p>
            <h3><?php echo $kategoriVeri['kategori_adi']; ?></h3>
        </div>
            ...
            <div class="col-md-9 col-lg-9">
                <div class="row">
                    ...
                    $veriCek=$conn->prepare("SELECT * FROM notler,firmalar,not_kategorileri WHERE
                      ...
                      AND notler.not_kategori_id = '$kategori_id'
                      ");
                    $veriCek->execute();
                        ...
                        <ul>
                            ...
                            while ($rowCat=$veriCekCat->fetch(PDO::FETCH_ASSOC)) {
                               ...
                               <li>
                                ...
                                <span><i class="far fa-seedling"></i> <?php echo $cesitSay['say']; ?> Çeşit
                                </span>
